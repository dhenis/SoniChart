...
public class Complex2Activity extends AppCompatActivity implements OnChartValueSelectedListener {
...
/*        mSeekBar = (SeekBar) findViewById(R.id.seekBar);
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Complex2Activity.this, Simple2Activity.class));
            }
        });
    }
