...
public class Complex5Activity extends AppCompatActivity implements OnChartValueSelectedListener, SeekBar.OnSeekBarChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        entries.add(new Entry(60F, 17));
        entries.add(new Entry(40F, 18));
        entries.add(new Entry(30F, 19));
        entries.add(new Entry(20F, 20));
        entries.add(new Entry(40F, 21));
        entries.add(new Entry(30F, 22));
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Complex5Activity.this, Complex6Activity.class));
            }
        });
    }
